        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose lg:prose-lg mx-auto mt-8 text-gray-700">
              <p>
                Welcome to Divine Path, a sanctuary for those seeking to connect with ancient traditions and spiritual wisdom. Our mission is to make authentic, high-quality spiritual products and services accessible to everyone, regardless of where they are on their journey.
              </p>
              <p>
              ...
              <p>
                Thank you for choosing Divine Path. We are honored to be a part of your spiritual exploration.
              </p>
            </div>
          </div>
        </div>
